  ...
  return (
    <div className="font-serif px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="mx-auto mb-10 lg:max-w-xl sm:text-center">
        <p className="inline-block px-3 py-px mb-4 text-white uppercase rounded-full bg-gradient-to-r from-yellow-500 to-red-600">
          Know Our Team
        </p>
      ...
      <div className="grid gap-10 mx-auto lg:grid-cols-2 lg:max-w-screen-lg">
        <div className="grid sm:grid-cols-3 lg:gap-40">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-sm tracking-wide text-gray-800">
              Director General for IGNIS MUN 2021, Arooja bharadwaj strongly believes that every opinion counts. She started her MUN journey back in 8th grade and has an experience of 7 MUNS tucked under her sleeve with a success rate of 100% and hopes to utilise her delegate and EB member experience to contribute and raise the bar for discussions.
            </p>
        ...
        <div className="grid sm:grid-cols-3 col-span-3">
          <div 
            className="relative w-full h-48 max-h-full rounded shadow sm:h-auto"
            style={{width: '200px',height:'200px',borderRadius:'50%'}}
          >
